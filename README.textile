...
First of all version 2.x does not deprecate version 1.x. The bugs found in 1.x would still be fixed but all new development will be done under JCL 2. The documentation for v1.x is available here. Following is a list of updates and changes in v2.x:
...
h2. Auto creating castable objects from factory
...
h2. Casting objects when required
